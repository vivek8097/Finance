...
public partial class fin_approve : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString["approve"] != null)
        {
            ...
            com1.ExecuteScalar();
            Response.Redirect("hr_approve.aspx?alert=Claim Flagged for Emergency");
            con.Close();
...
FROM            claim LEFT OUTER JOIN
                         ...
                         department_mast ON claim.pending_at_dept = department_mast.dept_id where pending_at_uid='"+Session["userid"]+"';", con);
            ...
            while (rd.Read())
            {
                string action = "";
                    ...
                    action += "<a href=\"view_fin_approve.aspx?approve=1&claim_id=" + rd.GetValue(0) + "\"><i class=\"glyphicon glyphicon-check\"></i></span></a>";
                    action += "<a href=\"fin_view_claim_status.aspx?claim_id=" + rd.GetValue(0) + "\"><i class=\"glyphicon glyphicon-search\"></i></span></a>";    
                //action += "Normaal";
